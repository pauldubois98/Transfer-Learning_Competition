...
def train_fn(disc_H, disc_Z, gen_Z, gen_H, loader, opt_disc, opt_gen, l1, mse, d_scaler, g_scaler, epoch):
    ...
    for idx, (zebra, horse) in enumerate(loop):
        ...
        if idx % 200 == 0:
            save_image(torch.cat((horse*0.5+0.5, fake_zebra*0.5+0.5)), f"saved_images/horse_epoch_{epoch}_{idx}.png")
            save_image(torch.cat((zebra*0.5+0.5, fake_horse*0.5+0.5)), f"saved_images/zebra_epoch_{epoch}_{idx}.png")
